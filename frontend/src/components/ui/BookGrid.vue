                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="PublishId">{{ val.publishId }}</td>
                            <td class="whitespace-nowrap" label="SubscribeCount">{{ val.subscribeCount }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Number label="SubscribeCount" v-model="selectedRow.subscribeCount" :editMode="true"/>
